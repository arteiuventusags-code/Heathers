...
const paginas = [
    "Pags/P01.png","Pags/P02.png","Pags/P03.png",
    "Pags/P04.png","Pags/P05.png","Pags/P06.png",
    "Pags/P07.png","Pags/P08.png","Pags/P09.png",
    "Pags/P10.png","Pags/P11.png","Pags/P12.png",
    "Pags/P13.png","Pags/P14.png","Pags/P15.png",
    "Pags/P16.png","Pags/P17.png","Pags/P18.png",
...
const fotos = [
    "Galeria/i (1).png", "Galeria/i (2).png", "Galeria/i (3).png",
    "Galeria/i (4).png", "Galeria/i (5).png", "Galeria/i (6).png",
    "Galeria/i (7).png", "Galeria/i (8).png", "Galeria/i (9).png",
    "Galeria/i (10).png", "Galeria/i (11).png", "Galeria/i (12).png",
    "Galeria/i (13).png", "Galeria/i (14).png", "Galeria/i (15).png",
    "Galeria/i (16).png", "Galeria/i (17).png", "Galeria/i (18).png",
    "Galeria/i (19).png"
];
...
musicBtn.addEventListener("click", () => {
    ...
    if (!musicPlaying) {
        ...
        musicBtn.textContent = "REANUDAR REPRODUCCIÓN";
...
function abrirGaleria(index){
    ...
    galleryImage.src = fotos[fotoActual];
...
galleryImage.parentElement.addEventListener(
    "wheel",
    panzoom.zoomWithWheel
);
...
/*Swipe*/
const hammer = new Hammer(galleryContent);
